...
$sql ="SELECT * FROM lectures WHERE Topic='" . $naam . "' ";
...
echo "<form action=login_teacher.php method=post>";
echo"<tr>";
...
echo"<td>" . "<input type = hidden name=delete value=delete" . " </td>";
echo"</tr>";
echo"</form>";
}
echo "<form action=login_teacher.php method=post>";
...
echo "<td>" . "<input type = hidden name=add value=add " . "</td>";
echo"</tr>";
echo "</form>";
echo "</table>";
mysql_close($con);
