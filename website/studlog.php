...
<center><font color="white" size=6>Sign In as</font><br><a href='contact.php'><font color="white" size=7>Student</font></a>
...
if (isset($_POST['login']))
{
	...
	$check_name="select * from students where
	...
	{
		echo "<font color='#B40707'><center><b>UserName or Password is incorrect!!! Please try again.</b></center></font>";
	}
}
?>
