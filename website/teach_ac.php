...
$UpdateQuery ="UPDATE teachers Set id='$_POST[id]', Name='$_POST[name]',Token='$_POST[password]' WHERE id='$_POST[hidden]'";
mysql_query($UpdateQuery,$con);
};

if(isset($_POST['delete'])){
$DeleteQuery="DELETE FROM teachers WHERE id='$_POST[hidden]'";
mysql_query($DeleteQuery,$con);
};

if(isset($_POST['add'])){
$AddQuery="INSERT INTO teachers (id, name, password) VALUES ('$_POST[uid]','$_POST[uname]','$_POST[upassword]')";
...
echo "<form action=teach_ac.php method=post>";
echo"<tr>";
