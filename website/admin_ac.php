   ...
   <li class='last'><a href="Token.php"><span>Tokens</span></a></li>
      ...
      <ul>
         ...
         <li class='has-sub'><a href="stud_ac.php"><span>Student A/C</span></a></li>
		  <li class='has-sub'><a href="admin_ac.php"><span>Admin A/C</span></a></li>
      </ul>
   </li>
...
$UpdateQuery ="UPDATE users Set id='$_POST[id]', Name='$_POST[name]',Token='$_POST[password]' WHERE id='$_POST[hidden]'";
...
if(isset($_POST['add'])){
$AddQuery="INSERT INTO users (id, name, password) VALUES ('$_POST[uid]','$_POST[uname]','$_POST[upassword]')";
...
echo "<form action=admin_ac.php method=post>";
echo "<tr>";
